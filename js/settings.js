...
function renderBackupModal() {
  ...
  document.getElementById('modalBody').innerHTML =
    ...
    + '<div><span class="settings-eyebrow">Segurança dos dados</span><h4>Backup e restauração</h4><p>Baixe uma cópia em JSON para guardar fora do sistema ou restaurar uma base já existente. Use antes de importações grandes, ajustes em lote ou conferências sensíveis.</p></div>'
    + '<div class="settings-hero-badge">Master / Consultor</div>'
    + '</div>'
    + '<div class="settings-section-card">'
    + '<div class="settings-card-grid backup-card-grid">'
    + '<div class="settings-action-card">'
    + '<span class="settings-action-title">Exportar dados</span>'
    + '<small>Gera um arquivo JSON com clientes, lançamentos, cartões, dívidas, financeiro, eventos e orçamento carregados no ambiente atual.</small>'
    ...
    + '</div>'
    + '<div class="settings-action-card">'
    + '<span class="settings-action-title">Quando usar</span>'
    + '<small>Antes de importar planilhas, corrigir uma base inteira, revisar duplicados ou testar mudanças em clientes compartilhados.</small>'
    + '</div>'
    + '<div class="settings-action-card">'
    + '<span class="settings-action-title">Cuidado operacional</span>'
    + '<small>Guarde o arquivo em local seguro. Ele pode conter dados financeiros e pessoais dos clientes cadastrados.</small>'
    + '</div>'
    + '</div>'
    + '</div>';
}
